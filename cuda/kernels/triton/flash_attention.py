...
Implements the Flash Attention algorithm (Dao et al.):
  - Block-wise computation of attention
  - Online softmax for numerical stability without materializing full attention matrix
